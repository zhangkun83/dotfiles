...
PARAMS = {
    'config#openbox/rc.xml' : {
        'hidpi' : {
            ...
            'CASCADE_STEP' : '100',
            'WINDOW_MOVE_STEP' : '60',
            'MOUSE_MOVE_STEP_X_LARGE': '600',
            'MOUSE_MOVE_STEP_Y_LARGE': '400',
            'MOUSE_MOVE_STEP_X_NORMAL': '150',
            'MOUSE_MOVE_STEP_Y_NORMAL': '100',
        ...
        'middpi' : {
            ...
            'CASCADE_STEP' : '100',
            'WINDOW_MOVE_STEP' : '60',
            'MOUSE_MOVE_STEP_X_LARGE': '480',
            'MOUSE_MOVE_STEP_Y_LARGE': '320',
            'MOUSE_MOVE_STEP_X_NORMAL': '120',
            'MOUSE_MOVE_STEP_Y_NORMAL': '80',
